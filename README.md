...
- **ユーザー側/管理者側クラス図・フィルタ動作解説**: [`docs/class-diagram-by-role.md`](docs/class-diagram-by-role.md)
- **機能別クラス図（JSP含む・全メンバー明示）**: [`docs/class-diagram-by-function.md`](docs/class-diagram-by-function.md)
