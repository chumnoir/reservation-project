...
<main class="admin-container">
    <div class="admin-page-head">
        ...
        <a href="${pageContext.request.contextPath}/combined/admin/notice?action=new" class="btn btn-primary">＋ 新規追加</a>
    </div>
                ...
                <tbody>
                    <c:forEach var="n" items="${notices}">
                        <tr>
                            ...
                            <td class="actions">
                                <a href="${pageContext.request.contextPath}/combined/admin/notice?action=edit&id=${n.noticeId}"
                                   class="btn btn-sm btn-outline">編集</a>
                                <form action="${pageContext.request.contextPath}/combined/admin/notice" method="post"
