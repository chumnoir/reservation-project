...
<body class="auth admin-auth">
    <div class="auth-box">
        ...
        <form action="${pageContext.request.contextPath}/combined/admin/login" method="post">
            <label>メールアドレス
        ...
        <p class="auth-link"><a href="${pageContext.request.contextPath}/combined/login">一般会員ログインはこちら</a></p>
    </div>
</body>
</html>
