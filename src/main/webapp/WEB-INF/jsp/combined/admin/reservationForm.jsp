...
<main class="admin-container narrow">
    ...
    <form action="${pageContext.request.contextPath}/combined/admin/reservation" method="post" class="admin-form">
        ...
        <div class="form-actions">
            <a href="${pageContext.request.contextPath}/combined/admin/reservation" class="btn btn-outline">戻る</a>
