...
<main class="admin-container">
    ...
    <div class="stat-grid">
        <div class="stat-card">
            ...
            <a href="${pageContext.request.contextPath}/combined/admin/notice" class="btn btn-sm btn-primary">管理する</a>
        </div>
        <div class="stat-card">
            <span class="stat-num">${workshopCount}</span>
            <span class="stat-label">ワークショップ</span>
            <a href="${pageContext.request.contextPath}/combined/admin/workshop" class="btn btn-sm btn-primary">管理する</a>
        </div>
        <div class="stat-card">
            <span class="stat-num">${reservationCount}</span>
            <span class="stat-label">予約</span>
            <a href="${pageContext.request.contextPath}/combined/admin/reservation" class="btn btn-sm btn-primary">管理する</a>
        </div>
        <div class="stat-card">
            <span class="stat-num">${memberCount}</span>
            <span class="stat-label">会員</span>
            <a href="${pageContext.request.contextPath}/combined/admin/member" class="btn btn-sm btn-primary">管理する</a>
        </div>
    </div>
</main>
</body>
