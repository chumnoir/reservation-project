...
<main class="admin-container narrow">
    ...
    <form action="${pageContext.request.contextPath}/combined/admin/notice" method="post" class="admin-form">
        <c:choose>
        ...
        <div class="form-actions">
            <a href="${pageContext.request.contextPath}/combined/admin/notice" class="btn btn-outline">戻る</a>
