                ...
                <tbody>
                    <c:forEach var="r" items="${reservations}">
                        <tr>
                            ...
                            <td class="actions">
                                <a href="${pageContext.request.contextPath}/admin/reservation?action=edit&id=${r.reservationId}"
                                   class="btn btn-sm btn-outline">編集</a>
                                <form action="${pageContext.request.contextPath}/admin/reservation" method="post"
