...
<main class="admin-container narrow">
    ...
    <form action="${pageContext.request.contextPath}/admin/workshop" method="post" class="admin-form">
        <c:choose>
        ...
        <div class="form-actions">
            <a href="${pageContext.request.contextPath}/admin/workshop" class="btn btn-outline">戻る</a>
