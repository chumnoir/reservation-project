...
<main class="admin-container">
    <div class="admin-page-head">
        ...
        <a href="${pageContext.request.contextPath}/admin/workshop?action=new" class="btn btn-primary">＋ 新規追加</a>
    </div>
                ...
                <tbody>
                    <c:forEach var="w" items="${workshops}">
                        <tr>
                            ...
                            <td class="actions">
                                <a href="${pageContext.request.contextPath}/admin/workshop?action=edit&id=${w.workshopId}"
                                   class="btn btn-sm btn-outline">編集</a>
                                <form action="${pageContext.request.contextPath}/admin/workshop" method="post"
